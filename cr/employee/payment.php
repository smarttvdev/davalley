...
// echo $_SESSION['order_id'];
 $order_history = $obj->get_order_item_list($_SESSION['order_id']);
...
<div class="PaymentInfo" style="margin-bottom: 65px;">
	<div class="container-fluid">
        ...
        <form method="POST" name="payment_form" id="payment_form">
            ...
            <div class="TipTab">
                <div class="col-md-3 col-sm-3 col-xs-3"><label>Discount&nbsp;:</label></div>
                <div class=" col-md-2 col-sm-3 col-xs-3"><input type="radio" name="discount_in_percent" value="10" <?php if(isset($get_payment_info['discount_percent']) and $get_payment_info['discount_percent']=="10"){echo "checked='checked'";}?>><span>10%</span></div>
                <div class=" col-md-2 col-sm-3  col-xs-3"> <input type="radio" name="discount_in_percent" value="15" <?php if(isset($get_payment_info['discount_percent']) and $get_payment_info['discount_percent']=="15"){echo "checked='checked'";}?>><span>15%</span></div>
                 <div class=" col-md-2 col-sm-3 col-xs-3"><input type="radio" name="discount_in_percent" value="20" <?php if(isset($get_payment_info['discount_percent']) and $get_payment_info['discount_percent']=="20"){echo "checked='checked'";}?>><span>20%</span></div>
            ...
            <div class="TipTab">
            	<div class="col-md-3 col-sm-3 col-xs-3"><label>Tips&nbsp;:</label></div>
                <div class="col-md-2 col-sm-3 col-xs-3"><input type="radio" name="tip_in_percent" value="10" <?php if(isset($get_payment_info['tip_percent']) and $get_payment_info['tip_percent']=="10"){echo "checked='checked'";}?>><span>10%</span></div>
                <div class="col-md-2 col-sm-3 col-xs-3"> <input type="radio" name="tip_in_percent" value="15" <?php if(isset($get_payment_info['tip_percent']) and $get_payment_info['tip_percent']=="15"){echo "checked='checked'";}?>><span>15%</span></div>
                 <div class="col-md-2 col-sm-3 col-xs-3"><input type="radio" name="tip_in_percent" value="20" <?php if(isset($get_payment_info['tip_percent']) and $get_payment_info['tip_percent']=="20"){echo "checked='checked'";}?>><span>20%</span></div>

                 <div class="col-md-3 col-sm-3 col-xs-3">                   
                    <input type="number" step=".01" placeholder="Calculated Or Input" name="calculate_percent_amt" value="<?php if(isset($get_payment_info['tip_amt'])){echo $get_payment_info['tip_amt'];}else{echo '0';}?>" id="calculate_percent_amt">
                </div>

            </div>
            <div class="TipTab">  
                <div class="form-group col-md-6 -col-sm-6 col-xs-6" style="float: right;margin-right: 12.5%;">
                    <label style="margin-left: 10%;">Balance Amount</label>
                    <input type="number" style="float: right;" step=".01" placeholder="Input Amount" name="balance_amt" id="balance_amt" value="<?php if(isset($get_payment_info['balance_amt'])){echo $get_payment_info['balance_amt'];}else{ echo $current_order_total;} ?>">
                </div>
            </div>
