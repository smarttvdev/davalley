    	...
    	<table width="100%">
            ...
            <tbody>
            	...
            	<tr>
                    ...
                    <td style="text-align:left;"><?php echo $items['itemName']; ?><br><span><?php echo $items['itemDescription']; ?></span></td>

                    <td style="text-align:right;">$<?php echo $items['itemPrice']; ?></td>                     
                ...
                <?php
                            ...
                            <tr>
                                ...
                                <td style="text-align:left;"><?php echo $items['item_discount_percent']; ?>% Discount </td>

                                <td style="text-align:right;">- <?php echo $items['item_discount_amount']; ?></td>                     
                ...
                <tr style="line-height:8px;">
                    ...
                    <td style="padding-top:30px; text-align:left;">Discount</td>

                    <td style="padding-top:30px; text-align:right;">$<?php echo $order_detail['discount_amt']; ?></td>
                ...
                <tr style="line-height:8px;">
                    ...
                    <td style="text-align:right;">$<?php echo $order_detail['tip_amt']; ?></td>
                ...
                <tr style="line-height:8px;">
                    ...
                    <td style="text-align:right;"><?php echo $tax['tax_percent']; ?>%</td>
                ...
                <tr style="line-height:8px;">
                    ...
                    <td style="text-align:right;">$<?php echo $order_detail['balance_amt']; ?></td>
                ...
                <tr style="line-height:8px;"> 
                    ...
                    <td style="padding-top:30px; text-align:right;">$<?php echo $order_detail['tendered_amt']; ?></td>
                ...
                <tr style="line-height:8px;"> 
                    ...
                    <td  style="text-align:right;">$<?php echo $order_detail['cash_change']; ?></td>
                ...
                <tr style="line-height:8px;">
                    ...
                    <td style="text-align:right;">$<?php echo $obj->get_order_total_amount_by_id($_REQUEST['order_id']); ?></td>
