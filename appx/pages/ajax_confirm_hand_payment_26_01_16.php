...
global $mysqli;
	...
	foreach($data as $row) {
		...
		$sql = "INSERT INTO `ordersPaid` (phone, orderID, itemID, cookWith, sideOrder, quantity, dateOrdered, cash, orderCompleted,orderBy) VALUES ('".$phone."','".$uniqueID."','".$row['itemID']."','".$row['cookWith']."','".$sideOrderval."','".$row['quantity']."',now(),'".$cash."','1','".$_SESSION['UserID']."')";
		$mysqli->query($sql);
	}
