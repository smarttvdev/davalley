...
<script type="text/javascript">
	...
	function openWin() {
		window.open("pages/print.php","myPrint","width=220, height=600");
	}
    </script>
...
?>
					...
					<input type='button' onclick='return openWin(0)' class='button button2' value='Print'>
<?php
	endif;
?>
				</td>
...
?>
					<form id='checkOutSubmit' method='post' action='<?php echo $url; ?>' >				   
						...
						<input type='hidden' name='x_cust_id' id='x_cust_id' value='<?php echo $_SESSION['phoneNumber']; ?>' />
...
endforeach;
?>
						<INPUT TYPE='HIDDEN' name='x_tax' VALUE='Tax<|>state tax<|><?php echo $total_tax; ?>'>
						<INPUT TYPE='HIDDEN' name='x_duty' VALUE='Tip<|>     Tip<|><?php echo $tipValue; ?>'>
						<input type='button' id='checkoutbtn' class='button button2' value='<?php echo $label; ?>'>
