			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				...
				<div class="panel panel-default">
					...
					<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
						<div class="panel-body">
<!--							<textarea id='cook-comment' Placeholder="Cook Message" style="width:100%;color:black;background: white;" name="cook_message"></textarea>-->
                        <textarea id='cook-comment' Placeholder="Cook Message" style="width:100%;" name="cook_message"></textarea>
...
if(isset($_REQUEST['add_to_cart'])){
    ...
    <tr id="item_row_<?php echo $add_item_to_order["itemID"]; ?>">
                                ...
                                <td class="text-center"><?php echo $get_total_order_item; ?></td>

<!--                                <td>--><?php //echo $add_item_to_order["side_order_item_ids"]; ?><!--</td>-->
                                <td><?php echo $add_item_to_order["itemCode"]; ?></td>
