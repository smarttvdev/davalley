...
<!--<!---End-->
<!--<style>-->
<!--    textarea.ui-widget-content .ui-corner-all .ui-keyboard-preview{-->
<!--        background:black;-->
<!--        color:white;-->
<!--    }-->
<!--</style>-->
...
<div class="paddTop50">
    ...
    if(isset($_SESSION['order_id'])){
        ...
        $query="select * from employee where id='$_SESSION[employee_id]'";
        $query_result=$mysqli->query($query);
        $user_info=$query_result->fetch_array(MYSQLI_ASSOC);
        $user_name=$user_info['firstname']." ".$user_info['lastname'];
        ?>
        <div class="_userinfo col-md-12">
            <div class="row">
<!--                <div class="col-md-3 col-xs-3 col-sm-3">-->
<!--                    <p><label>User:</label> --><?php //echo $user_name; ?><!--</p>-->
<!--                </div>-->
<!--                <div class="col-md-3 col-xs-3 col-sm-3">-->
...
<!--                </div>-->
        ...
        <div class="container_12 divider">
            <div class="grid_12 height250">
                <table class="fancyTable table-border" id="myTable02" cellpadding="0" cellspacing="0">
                    <thead>
                    <tr>
                        <th>No</th>
                        <th>Id</th>
                    ...
                    while ($list_items = $get_order_items->fetch_array()) {
                        ...
                        <tr id="item_row_<?php echo $list_items["itemID"]; ?>">
                            ...
                            <td class="QTY">
                                <div class="input-group" style="width:50px;margin:auto">
        ...
        <div class="orderListing">
            ...
            <div class="Frequentyorder FrequentyorderNext">
                ...
                <div class="TableScrollSecond">
                    ...
                    while($results =$get_menu_items->fetch_array()){
                        ?>
                        <a href="#" onclick="add_to_cart_item('<?php echo $results["itemID"]; ?>')">
                            <div class="ItemList">
                ...
                <div class="FullItem">
                    <div class="tabs-left">
                        <ul class="nav nav-tabs">
                            ...
                            $cat_array = array();
                            $index = 1;
                            while ( $category = $get_all_item_category->fetch_array()){
                            ...
                            foreach ($cat_array as $key => $value) {
                                ...
                                <div class="tab-pane <?php if($key==0){ echo 'active';} ?>" id="cat_tab_<?php echo $value; ?>">
                                    <div class="Frequentyorder itemFulllist">
                                        ...
                                        while ($items_list = $get_items_by_category->fetch_array()) {
                                            ?>
