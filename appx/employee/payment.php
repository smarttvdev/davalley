...
<!--                </tr>-->
        ...
        <form method="POST" name="payment_form" id="payment_form">
            ...
            <div class="TipTab" style="display: none">
<!--            <div class="TipTab">-->
                <div class="col-xs-2"><label>Discount&nbsp;:</label></div>
                <div class="col-xs-2"><input type="radio" name="discount_in_percent" value="10" <?php if(isset($get_payment_info['discount_percent']) and $get_payment_info['discount_percent']=="10"){echo "checked='checked'";}?>><span>10%</span></div>
                <div class="col-xs-2"> <input type="radio" name="discount_in_percent" value="15" <?php if(isset($get_payment_info['discount_percent']) and $get_payment_info['discount_percent']=="15"){echo "checked='checked'";}?>><span>15%</span></div>
                <div class="col-xs-2"><input type="radio" name="discount_in_percent" value="20" <?php if(isset($get_payment_info['discount_percent']) and $get_payment_info['discount_percent']=="20"){echo "checked='checked'";}?>><span>20%</span></div>
                <div class="col-xs-4" style="padding-right:10px"><input type="number" style="padding: 5px;border: 1px solid #d4d4d4;margin-top:0px; width:100%" step=".01" placeholder="Calculated Or Input" id="discount_percent_amt" name="discount_percent_amt" value="<?php if(isset($get_payment_info['discount_amt'])){echo $get_payment_info['discount_amt'];}else{echo '0';}?>" id="discount_percent_amt"></div>
            </div>
<!--            <div class="Manual-tip" style="display: none">-->
<!--            <div class="Manual-tip">-->
<!--                <div class="form-group">-->
<!--                    <label>Enter Discount Amount</label>-->
<!--                    <input type="number" step=".01" placeholder="Calculated Or Input" id="discount_percent_amt" name="discount_percent_amt" value="--><?php //if(isset($get_payment_info['discount_amt'])){echo $get_payment_info['discount_amt'];}else{echo '0';}?><!--" id="discount_percent_amt">-->
<!--                </div> -->
<!--            </div>-->
            <div class="TipTab">
            	<div class="col-xs-2"><label>Tips&nbsp;:</label></div>
                <div class="col-xs-2"><input type="radio" name="tip_in_percent" value="10" <?php if(isset($get_payment_info['tip_percent']) and $get_payment_info['tip_percent']=="10"){echo "checked='checked'";}?>><span>10%</span></div>
                <div class="col-xs-2"> <input type="radio" name="tip_in_percent" value="15" <?php if(isset($get_payment_info['tip_percent']) and $get_payment_info['tip_percent']=="15"){echo "checked='checked'";}?>><span>15%</span></div>
                <div class="col-xs-2"><input type="radio" name="tip_in_percent" value="20" <?php if(isset($get_payment_info['tip_percent']) and $get_payment_info['tip_percent']=="20"){echo "checked='checked'";}?>><span>20%</span></div>
                <div class="col-xs-4 col-sm-4" style="padding-right:10px"><input type="number" style="padding: 5px;border: 1px solid #d4d4d4;margin-top:0px; width:100%" step=".01" placeholder="Calculated Or Input" name="calculate_percent_amt" value="<?php if(isset($get_payment_info['tip_amt'])){echo $get_payment_info['tip_amt'];}else{echo '0';}?>" id="calculate_percent_amt"></div>
            </div>
            <div class="Manual-tip">            
<!--            	<div class="form-group">-->
<!--                	<label style="width:150px">Enter Tip Amount</label>-->
<!--                    <button class="form-inline" name="payment_button" id="payment_button">Swipe Card</button><!--                   -->
<!--                </div>-->
                <div class="form-group">
                    <button  type="button" name="payment_button" id="payment_button">Swipe Card</button>
                    <label>Balance Amount</label>
                    <input type="number" step=".01" placeholder="Input Amount" name="balance_amt" id="balance_amt" value="<?php if(isset($get_payment_info['balance_amt'])){echo $get_payment_info['balance_amt'];}else{ echo $current_order_total;} ?>">
                </div>
<!--                <div class="form-group">-->
<!--                    <label>Card Pay Amount</label>-->
<!--                    <input type="number" step=".01" placeholder="Input Amount" name="card_pay_amt" id="card_pay_amt" value="--><?php //if(isset($get_payment_info['cart_pay_amount'])){echo $get_payment_info['cart_pay_amount'];}else{ echo "0";} ?><!--">-->
<!--                </div>-->
                <div class="form-group">
                    <button type="button" name="save_order_payment" id="save_order_payment">Cash Payment</button>
