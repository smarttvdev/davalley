...
<html>
    ...
    <p>
      <h2>NOTE</h2>
      <p>Since Chrome version 47, Voice Recording works only on HTTPS sites. You can see the demo on HTTPS .</p>
    </p>
    <h2>Record</h2>
		<audio controls id="audio"></audio><br>

		
			<label>Saved Audio File playing:</label><br>
			
			<input type="button" id="Submit" value="play" style="width: 200px; height: 50px;background-color: green;" /><br>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				$('#Submit').click(function(){
					var url = "./uploads/recorded_audio.wav"
					$("#audio").attr("src", url);
