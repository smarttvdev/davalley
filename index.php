...
if($i == 1 && $j != '') {
      ...
      $From = preg_match_all("/\d+/i", isset($_GET['From']), $From_output);
      ...
      <div id="header">
        <div class="navigation">
          ...
          <a href="pages/pictures.php" id = "pictures">
            <img alt="Image-alt"
             src="<?php echo $CONFIG['site'];?>/images/icons/tab-bar/Picture.png" width="24" />
            <em><br />Pictures</em>
          </a>
          ...
          ?>
          <a href="pages/category.php" id="category" ></a>
